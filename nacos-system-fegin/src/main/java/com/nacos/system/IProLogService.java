...
import com.nacos.system.hystrix.ProLogServiceHystrix;
...
public interface IProLogService {
    ...
    */
    ...
    ServiceResponse<List<ProLog>> batchSave(
        @RequestBody ProParameter<List<ProLogRequest>> proParameter) throws Exception;
}
