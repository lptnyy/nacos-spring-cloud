...
import com.nacos.system.hystrix.ProRoleMenuServiceHystrix;
...
public interface IProRoleMenuService {
    ...
    ServiceResponse<List<ProRoleMenu>> getList(
        @RequestBody ProParameter<ProRoleMenuRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProRoleMenu>> getPageList(
        @RequestBody ProParameter<ProRoleMenuRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProRoleMenu>> findIdsList(
        @RequestBody ProParameter<ProRoleMenuRequest> proParameter) throws Exception;
    ...
    */
    ...
    ServiceResponse<Integer> batchSave(
        @RequestBody ProParameter<List<ProRoleMenuRequest>> proParameter) throws Exception;
}
