...
public interface IProResourceFileService {
    ...
    ServiceResponse<ProResourceFile> get(
        @RequestBody ProParameter<ProResourceFileRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProResourceFile>> getList(
        @RequestBody ProParameter<ProResourceFileRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProResourceFile>> getPageList(
        @RequestBody ProParameter<ProResourceFileRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProResourceFile>> findIdsList(
        @RequestBody ProParameter<ProResourceFileRequest> proParameter) throws Exception;
    ...
    ServiceResponse<ProResourceFile> save(
        @RequestBody ProParameter<ProResourceFileRequest> proParameter) throws Exception;
    ...
    */
    ...
    ServiceResponse<List<ProResourceFile>> batchSave(
        @RequestBody ProParameter<List<ProResourceFileRequest>> proParameter) throws Exception;
}
