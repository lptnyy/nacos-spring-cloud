package com.nacos.generator.service;

import com.nacos.common.feign.FeignRequestInterceptor;
import com.nacos.common.method.ProParameter;
import com.nacos.common.util.ServiceResponse;
import com.nacos.generator.dto.ProGenerator;
import com.nacos.generator.request.ProGeneratorRequest;
...
public interface IProGeneratorService {
    ...
    ServiceResponse<List<ProGenerator>> getList(
        @RequestBody ProParameter<ProGeneratorRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProGenerator>> getPageList(
        @RequestBody ProParameter<ProGeneratorRequest> proParameter) throws Exception;
    ...
    ServiceResponse<List<ProGenerator>> findIdsList(
        @RequestBody ProParameter<ProGeneratorRequest> proParameter) throws Exception;
    ...
    */
    ...
    ServiceResponse<List<ProGenerator>> batchSave(
        @RequestBody ProParameter<List<ProGeneratorRequest>> proParameter) throws Exception;
}
